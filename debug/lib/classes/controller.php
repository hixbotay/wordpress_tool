...
class JControllerLegacy extends JObject
{
	...
	public static function getInstance($prefix, $config = array())
	{
		...
		if (!class_exists($class))
		{
			...
			{
				throw new InvalidArgumentException(('JLIB_APPLICATION_ERROR_INVALID_CONTROLLER'));
			}
		}
		...
		if (!class_exists($class))
		{
			throw new InvalidArgumentException(('JLIB_APPLICATION_ERROR_INVALID_CONTROLLER_CLASS'));
		}
