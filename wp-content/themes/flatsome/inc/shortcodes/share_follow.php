...
function flatsome_follow($atts, $content = null) {
    ...
    <div class="social-icons follow-icons <?php echo $align; ?>" <?php echo $scale;?>>
		...
		<?php }?>
		<?php if($email){?>
		     <a href="mailto:<?php echo $email; ?>" data-label="E-mail"  rel="nofollow" class="<?php echo $style; ?>  email tooltip" title="<?php echo $email ?>"><?php echo get_flatsome_icon('icon-envelop'); ?>
			</a>
		<?php }?>
	    <?php if($phone){?>
			<a href="tel:<?php echo $phone; ?>" target="_blank"  data-label="Phone"  rel="nofollow" class="<?php echo $style; ?>  phone tooltip" title="<?php echo $phone ?>"><?php echo get_flatsome_icon('icon-phone'); ?>
			</a>
	    <?php }?>
		<?php if($pinterest){?>
